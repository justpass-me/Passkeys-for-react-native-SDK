...
class AmwalAuthReactNativeModule(val reactContext: ReactApplicationContext) :
  ...
  private val currentActivity = reactContext.getCurrentActivity() as AppCompatActivity;
  private val createCredentialIntentLauncher =
    currentActivity.registerForActivityResult(ActivityResultContracts.StartIntentSenderForResult()) { activityResult: ActivityResult ->
